...
| Understand how AI agent work is governed | [AIOS](aios/README.md) |
...
```text
aios/                    How AI agent work is governed (structure only)
├── 00-CONSTITUTION/     Rules and vocabulary
├── 01-ROLES/            Agent roles and accountability
├── 02-MODELS/           Per-vendor model operating notes
