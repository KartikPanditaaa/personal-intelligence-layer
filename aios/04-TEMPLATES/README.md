...
Source: AIOS v0.1.0 Sprint 1, amended per the Sprint 1 governance resolution draft (proposed, founder approval pending). No template has been written.
---
...
- **Product templates.** Those already exist at
  ...
  already fit rather than forking them. This includes ADR and RFC forms
  specifically: AIOS reuses
  [ADR_TEMPLATE](../../docs/18-templates/ADR_TEMPLATE.md) and
  [RFC_TEMPLATE](../../docs/18-templates/RFC_TEMPLATE.md) as-is and does not
  maintain AIOS-specific copies.
...
AIOS does not fork ADR and RFC forms; it reuses
[ADR_TEMPLATE](../../docs/18-templates/ADR_TEMPLATE.md) and
[RFC_TEMPLATE](../../docs/18-templates/RFC_TEMPLATE.md) directly. Departing
from that - forking a form because AIOS genuinely needs a field the product
form does not have - is a [05-GOVERNANCE](../05-GOVERNANCE/README.md)
