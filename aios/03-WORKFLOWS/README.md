...
Source: AIOS v0.1.0 Sprint 1, amended per the Sprint 1 governance resolution draft (proposed, founder approval pending). No workflow has been written.
---
...
| [02-MODELS](../02-MODELS/README.md) | Per-vendor notes a step may draw on when it names a model |
