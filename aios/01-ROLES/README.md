...
Tags: aios, roles, stub
Source: AIOS v0.1.0 Sprint 1, amended per the Sprint 1 governance resolution draft (proposed, founder approval pending). No role has been defined.
---
...
The roster of roles and the authority model behind it is `AGENTS.md`, which
lives in [00-CONSTITUTION](../00-CONSTITUTION/README.md) because it is
constitutional rather than operational. This section holds the individual
role documents `AGENTS.md` indexes, not the roster itself.
...
- `AGENTS.md` itself - that is constitutional and lives in
